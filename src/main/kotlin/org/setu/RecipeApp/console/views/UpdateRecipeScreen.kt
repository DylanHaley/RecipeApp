...
class UpdateRecipeScreen : View("Update Recipes") {
    ...
    override val root = vbox {
        ...
        tableview(data) {
            ...
            readonlyColumn("TITLE", RecipeAppModel::title).makeEditable()
            readonlyColumn("INGREDIENTS", RecipeAppModel::ingredients).makeEditable()
            readonlyColumn("DESCRIPTION", RecipeAppModel::description).makeEditable()
        }
        button("Close") {
            useMaxWidth = true
            action {
                runAsyncWithProgress {
                    recipeUIController.closeUpdateRecipe()
                }
            }
        }
    }
